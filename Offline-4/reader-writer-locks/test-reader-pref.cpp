...
int main(int argc, char *argv[]) {
  ...
  long *max_reader_acquire_time =
      max_element(readerAcquireTime, readerAcquireTime + 2 * read_num_threads);
  long *min_reader_release_time =
      min_element(readerReleaseTime, readerReleaseTime + 2 * read_num_threads);
  long *max_reader_release_time =
      max_element(readerReleaseTime, readerReleaseTime + 2 * read_num_threads);
  ...
  if ((read_num_threads > 0) &&
      (*max_reader_acquire_time > *min_reader_release_time)) {
